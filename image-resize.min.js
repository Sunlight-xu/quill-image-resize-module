...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__icons_align_left_svg__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__icons_align_left_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__icons_align_left_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__icons_align_center_svg__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__icons_align_center_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__icons_align_center_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__icons_align_right_svg__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__icons_align_right_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__icons_align_right_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__icons_full_svg__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__icons_full_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__icons_full_svg__);
...
var WidthAttribute = new Parchment.Attributor.Attribute('width', 'width');
...
var Toolbar = function (_BaseModule) {
	...
	function Toolbar() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
			...
			_this.alignments = [{
				icon: __WEBPACK_IMPORTED_MODULE_0__icons_align_left_svg___default.a,
				...
				icon: __WEBPACK_IMPORTED_MODULE_1__icons_align_center_svg___default.a,
				apply: function apply() {
				...
				icon: __WEBPACK_IMPORTED_MODULE_2__icons_align_right_svg___default.a,
				apply: function apply() {
					DisplayStyle.add(_this.img, 'inline');
				...
				icon: __WEBPACK_IMPORTED_MODULE_3__icons_full_svg___default.a,
				apply: function apply() {
					DisplayStyle.add(_this.img, 'block');
					FloatStyle.remove(_this.img);
					WidthAttribute.add(_this.img, '100%');
				},
				isApplied: function isApplied() {
					return WidthAttribute.value(_this.img) == '100%';
				}
			}];
			...
			_this.alignments.forEach(function (alignment, idx) {
				...
				button.addEventListener('click', function () {
					...
					if (alignment.isApplied()) {
						...
						WidthAttribute.remove(_this.img);
					} else {
...
var ImageResize = function ImageResize(quill) {
	...
	this.quill.container.children[0].addEventListener('scroll', function () {
		_this.onUpdate();
	});
